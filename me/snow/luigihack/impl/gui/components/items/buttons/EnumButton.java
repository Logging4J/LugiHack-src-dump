...
public class EnumButton extends Button
{
    ...
    public void drawScreen(final int n, final int n2, final float n3) {
        ...
        LuigiHack.textManager.drawStringWithShadow(String.valueOf(new StringBuilder().append(this.setting.getName()).append(" §7").append(this.setting.currentEnumName())), this.x + 2.3f, this.y - 4.0f - LuigiGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
