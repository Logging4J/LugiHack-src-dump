...
public class AnnotatedMixinElementHandlerSoftImplements extends AnnotatedMixinElementHandler
{
    ...
    private void processMethod(final Interface.Remap remap, final TypeHandle typeHandle, final String str, final ExecutableElement executableElement) {
        ...
        if (str != null) {
            final MethodHandle method2 = this.mixin.getHandle().findMethod(str + string, javaSignature);
            if (method2 != null) {
                this.addInterfaceMethodMapping(remap, typeHandle, str, method2, string, descriptor);
            }
        }
    }
    ...
    private void addInterfaceMethodMapping(final Interface.Remap remap, final TypeHandle typeHandle, final String s, final MethodHandle methodHandle, final String s2, final String s3) {
        ...
        this.addMethodMappings(methodHandle.getName(), s3, (ObfuscationData)this.applyPrefix(obfMethod, s));
    }
