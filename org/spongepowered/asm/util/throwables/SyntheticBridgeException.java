...
public class SyntheticBridgeException extends MixinException
{
    ...
    public enum Problem
    {
        ...
        String getMessage(final String s, final String s2, final int i, final AbstractInsnNode abstractInsnNode, final AbstractInsnNode abstractInsnNode2) {
            return String.format(this.message, s, s2, i, Bytecode.getOpcodeName(abstractInsnNode), Bytecode.getOpcodeName(abstractInsnNode), getInsnName(abstractInsnNode), getInsnName(abstractInsnNode2), getInsnDesc(abstractInsnNode), getInsnDesc(abstractInsnNode2));
        }
