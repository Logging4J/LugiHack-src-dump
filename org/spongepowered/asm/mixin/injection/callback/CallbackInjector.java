...
public class CallbackInjector extends Injector
{
    ...
    private String getIdentifier(final Callback callback) {
        final String str = Strings.isNullOrEmpty(this.identifier) ? callback.target.method.name : this.identifier;
        final String str2 = this.ids.get(callback.node.getId());
    ...
    static String meltSnowman(final int i, final String s) {
        return (s != null && '\u2603' == s.charAt(0)) ? ("var" + i) : s;
    }
    ...
    private class Callback extends InsnList
    {
        ...
        Callback(final MethodNode handler, final Target target, final InjectionNodes.InjectionNode node, final LocalVariableNode[] locals, final boolean b) {
            this.marshalVar = -1;
            ...
            if (locals != null) {
                final int n = CallbackInjector.this.isStatic() ? 0 : 1;
