...
public abstract class InjectionInfo extends SpecialMethodInfo implements ISliceContext
{
    ...
    protected void parseInjectionPoints(final List<AnnotationNode> list) {
        this.injectionPoints.addAll(InjectionPoint.parse((IMixinContext)this.mixin, this.method, this.annotation, (List)list));
    }
    ...
    public void prepare() {
        ...
        while (iterator.hasNext()) {
            ...
            this.targetNodes.put(targetMethod, this.injector.find(injectorTarget, (List)this.injectionPoints));
    ...
    protected String getDynamicInfo() {
        final AnnotationNode invisible = Annotations.getInvisible(this.method, (Class<? extends Annotation>)Dynamic.class);
