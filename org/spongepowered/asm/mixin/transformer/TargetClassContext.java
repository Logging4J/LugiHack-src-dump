...
class TargetClassContext extends ClassContext implements ITargetClassContext
{
    ...
    void applyMixins() {
        ...
        this.applied = true;
        this.createApplicator().apply((SortedSet)this.mixins);
        this.applySignature();
        this.upgradeMethods();
        this.checkMerges();
    }
    ...
    void processDebugTasks() {
        ...
        final AnnotationNode visible = Annotations.getVisible(this.classNode, (Class<? extends Annotation>)Debug.class);
        if (visible != null) {
        ...
        for (final MethodNode methodNode : this.classNode.methods) {
            final AnnotationNode visible2 = Annotations.getVisible(methodNode, (Class<? extends Annotation>)Debug.class);
