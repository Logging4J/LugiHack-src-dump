...
class MethodWriter extends MethodVisitor
{
    ...
    MethodWriter(final ClassWriter cw, final int access, final String anObject, final String descriptor, final String signature, final String[] array, final int compute) {
        super(327680);
    ...
    public AnnotationVisitor visitParameterAnnotation(final int n, final String anObject, final boolean b) {
        ...
        byteVector.putShort(this.cw.newUTF8(anObject)).putShort(0);
        final AnnotationWriter annotationWriter = new AnnotationWriter(this.cw, true, byteVector, byteVector, 2);
        if (b) {
            if (this.panns == null) {
    ...
    public void visitFrame(final int n, final int n2, final Object[] array, final int b, final Object[] array2) {
        ...
        if (this.compute == 1) {
            if (this.currentBlock.frame == null) {
                ...
                if (n == -1) {
                    this.currentBlock.frame.set(this.cw, n2, array, b, array2);
                }
            ...
            int startFrame = this.startFrame(this.code.length, n2, b);
            for (int i = 0; i < n2; ++i) {
    ...
    public void visitMaxs(final int n, final int maxLocals) {
        if (this.compute == 0) {
            ...
            while (next != null) {
                ...
                label5.status |= 0x40;
                final int n2 = frame2.inputStack.length + label3.outputStackMax;
                if (n2 > max) {
                    max = n2;
                }
            ...
            for (Label label6 = this.labels; label6 != null; label6 = label6.successor) {
                ...
                if ((label6.status & 0x40) == 0x0) {
                    ...
                    final int n3 = ((successor == null) ? this.code.length : successor.position) - 1;
                    if (n3 >= position) {
                        max = Math.max(max, 1);
                        for (int i = position; i < n3; ++i) {
                            this.code.data[i] = 0;
                        }
                        this.code.data[n3] = -65;
                ...
                for (Label label8 = this.labels; label8 != null; label8 = label8.successor) {
                    if ((label8.status & 0x80) != 0x0) {
                        ...
                        if ((successor2.status & 0x400) == 0x0) {
                            ++n4;
                            successor2.visitSubroutine((Label)null, n4 / 32L << 32 | 1L << n4 % 32, this.subroutines);
                        }
                    }
                }
        ...
        while (true) {
            ...
            switch (this.descriptor.charAt(n++)) {
                ...
                case '[': {
                    ...
                    this.frame[startFrame++] = (0x1700000 | this.cw.addType(this.descriptor.substring(beginIndex, ++n)));
                    continue;
                }
                case 'L': {
                    while (this.descriptor.charAt(n) != ';') {
                    ...
                    this.frame[startFrame++] = (0x1700000 | this.cw.addType(this.descriptor.substring(beginIndex + 1, n++)));
                    continue;
                }
                default: {
