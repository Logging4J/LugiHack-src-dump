...
public class MethodNode extends MethodVisitor
{
    ...
    public MethodNode(final int n, final int access, final String name, final String desc, final String signature, final String[] a) {
        super(n);
        this.access = access;
        this.name = name;
        this.desc = desc;
        this.signature = signature;
        this.exceptions = new ArrayList<String>((a == null) ? 0 : a.length);
        if ((access & 0x400) == 0x0) {
