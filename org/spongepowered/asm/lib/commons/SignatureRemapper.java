...
public class SignatureRemapper extends SignatureVisitor
{
    ...
    @Override
    public void visitClassType(final String item) {
        this.classNames.push(item);
        this.v.visitClassType(this.remapper.mapType(item));
    }
    
    @Override
    public void visitInnerClassType(final String str) {
        final String str2 = this.classNames.pop();
        final String string = str2 + '$' + str;
        this.classNames.push(string);
        final String string2 = this.remapper.mapType(str2) + '$';
